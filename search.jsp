...
<h1 style="color:blue;text-align:center">Related webs in the database are::</h1>
    ...
    <c:otherwise>
    	<h1 style="color:red;text-align:center">The data related to given word is not found</h1>
    </c:otherwise>
    </c:choose>
     <h1 style="text-align:center">The status of user-name and user-id are saved ${status}</h1>
